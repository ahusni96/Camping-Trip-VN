...
define Description = "" # Personality Description
...
label common:
    ...
    menu:
        "I should go camping tomorrow.":    # Judger
            $ judging = False
            call common.tomorrow
        
        "I should go camping next week":    # Perceiver
            $ judging = True
            call common.next_week
...
label .secondary:
    ...
    if Dominant != "" and Auxiliary == "":
        if (Dominant == "Si" or Dominant == "Ni"):
            if Fe:
                $ Auxiliary = "Fe"
            elif Te:
                $ Auxiliary = "Te"
        
        elif (Dominant == "Fe" or Dominant == "Te"):
            if Si:
                $ Auxiliary = "Si"
            elif Ni:
                $ Auxiliary = "Ni"

        elif (Dominant == "Fi" or Dominant == "Ti"):
            if Se:
                $ Auxiliary = "Se"
            elif Ne:
                $ Auxiliary = "Ne" 

        elif (Dominant == "Se" or Dominant == "Ne"):
            if Fi:
                $ Auxiliary = "Fi"
            elif Ti:
                $ Auxiliary = "Ti"
